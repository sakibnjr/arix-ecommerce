          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
            {contactMethods.map((method, index) => (
              <div key={method.title} className="text-center group">
                <div
                  className={`bg-gradient-to-br ${method.color} w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300`}
                >
                  {index === 0 && (
                    <AiOutlineMail className="w-10 h-10 text-white" />
                  )}
                  {index === 1 && (
                    <AiOutlinePhone className="w-10 h-10 text-white" />
                  )}
                  {index === 2 && (
                    <AiOutlineEnvironment className="w-10 h-10 text-white" />
                  )}
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
              <div className="bg-gray-50 p-6 rounded-xl">
                ...
                <p className="text-body-md text-gray-600">
                  Standard shipping takes 3-5 business days within Bangladesh.
              ...
              <div className="bg-gray-50 p-6 rounded-xl">
                ...
                <p className="text-body-md text-gray-600">
                  ...
                  condition. Contact us for return instructions.
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-xl">
                ...
                <p className="text-body-md text-gray-600">
                  Absolutely! All our products are officially licensed and
                  authentic, ensuring the highest quality.
                </p>
              </div>
            </div>
          </div>
