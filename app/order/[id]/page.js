        ...
        {!loaded ? (
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-xl p-8 text-center">
            <p className="text-gray-700 mb-4">
              We couldn&apos;t find an order with this tracking number.
            </p>
            <Link
              href="/"
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
              ...
              <div className="flex items-center justify-between">
                {steps.map((s, idx) => {
                  ...
                  const isDone =
                    idx <= currentIdx || (isCancelled && idx === 0);
                    ...
                    <div key={s} className="flex-1 flex items-center">
                      <motion.div
                        ...
                        transition={{
                          ...
                          stiffness: 260,
                          damping: 18,
                          delay: isDelivered ? idx * 0.05 : 0,
                        }}
                        className={`flex items-center justify-center w-9 h-9 rounded-full text-xs font-semibold border ${
                          isDone
                            ? doneCircleClass
                          ...
                          {!isCancelled && (
                            <motion.div
                              className={`absolute left-0 top-0 h-0.5 ${
                                isDelivered ? "bg-green-600" : "bg-black"
                              }`}
                              initial={{ width: 0 }}
                              animate={{
                                width:
                    ...
                    >
                      <div>
                        ...
                        <div className="text-sm text-gray-600">
                          {it.anime} • {it.category} • Size {it.size}
                        </div>
                      </div>
