        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex" aria-label="Breadcrumb">
            <ol className="flex items-center space-x-3 sm:space-x-4">
              <li>
                <Link href="/" className="text-sm sm:text-base text-gray-500 hover:text-black transition-colors">
                  Home
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href={`/anime/${product.anime.toLowerCase().replace(/\s+/g, '-')}`} className="text-sm sm:text-base text-gray-500 hover:text-black transition-colors">
                  {product.anime}
                </Link>
              </li>
              <li>
              ...
              <li>
                <span className="text-sm sm:text-base text-gray-900 font-medium">{product.name}</span>
              </li>
            </ol>
          </nav>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-14 lg:items-start">
              ...
              {productImages[activeImageIndex]?.src ? (
                ...
                <div className="w-full h-full bg-gray-100 flex items-center justify-center">
                  <div className="text-center text-gray-600">
                    ...
                    <p className="text-base sm:text-lg font-medium">{productImages[activeImageIndex]?.placeholder || 'No Image'}</p>
              ...
              {productImages.map((image, index) => (
                <button
                  ...
                  className={`aspect-square rounded-lg overflow-hidden border transition-colors ${
                    index === activeImageIndex ? 'border-black ring-2 ring-black' : 'border-gray-200 hover:border-gray-400'
                  }`}
                >
                  {image.src ? (
                    <img
          ...
          <div className="lg:pl-8 lg:sticky lg:top-24">
            ...
            <div className="flex items-center gap-2 mb-3">
              ...
              {product.isNew && (
                <span className="text-xs sm:text-sm bg-white text-gray-900 px-2.5 sm:px-3 py-1 rounded-full font-medium border border-gray-300">NEW</span>
              )}
              {hasDiscount && (
                <span className="text-xs sm:text-sm bg-black text-white px-2.5 sm:px-3 py-1 rounded-full font-medium">SALE</span>
              )}
            </div>

            {/* Enhanced Product Name */}
            <h1 className="font-display text-2xl sm:text-3xl lg:text-4xl text-gray-900 mb-3 sm:mb-5 leading-tight">{product.name}</h1>
            ...
            <div className="flex items-center gap-3 sm:gap-4 mb-5 sm:mb-6">
              ...
              {hasDiscount && (
                <span className="text-sm sm:text-base text-gray-700">Save ৳{(product.originalPrice - product.price).toFixed(2)}</span>
              )}
            </div>
            ...
            <div className="mb-6">
              <h3 className="font-display text-base sm:text-lg text-gray-900 mb-2">Size</h3>
            ...
            <div className="mb-6 sm:mb-8">
              <h3 className="font-display text-base sm:text-lg text-gray-900 mb-2">Quantity</h3>
              <div className="inline-flex items-center border border-gray-300 rounded-full bg-white overflow-hidden">
                ...
                <span className="px-4 py-2 font-semibold text-gray-900 select-none">{quantity}</span>
                <button
        ...
        <div className="mt-8 sm:mt-12 max-w-3xl">
          ...
          <div className="border-t border-gray-200">
            ...
            >
              <span className="font-display text-lg sm:text-xl text-gray-900">Size Guide</span>
              <div className={`transition-transform duration-300 ${openSections.size ? 'rotate-90' : ''}`}>
          ...
          <div className="border-t border-gray-200">
            ...
            >
              <span className="font-display text-lg sm:text-xl text-gray-900">Care Instructions</span>
              <div className={`transition-transform duration-300 ${openSections.care ? 'rotate-90' : ''}`}>
                <ChevronRightIcon className="w-5 h-5 text-gray-500" />
              </div>
            </button>
            {openSections.care && (
          ...
          <div className="border-t border-gray-200">
            ...
            >
              <span className="font-display text-lg sm:text-xl text-gray-900">Shipping</span>
              <div className={`transition-transform duration-300 ${openSections.shipping ? 'rotate-90' : ''}`}>
                <ChevronRightIcon className="w-5 h-5 text-gray-500" />
              </div>
            </button>
